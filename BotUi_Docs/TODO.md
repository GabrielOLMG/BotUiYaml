...
- transforamr pipeline em uma classe
- endpoint para alterar step ongoing(precisa ter id associado!!)
- modo debug(vindo do endpoint apenas) pernmite o step entrar em modo pausa, possibilitando vc alterar o step atual com alguma informçao necessaria, como por exemplo , mudar o text em find text, caso vc tenha escolhido errado))
