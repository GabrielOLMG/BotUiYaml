...
- falar sobre next  do find
    - dar exemplo de um optional(true e false indo para o msm lugar), if_find(true indo para o msm step). e until_find(false indo p msm step)
